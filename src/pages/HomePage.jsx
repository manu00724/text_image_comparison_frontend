...
import { submitGuaranteeForReview } from '../services/bgReviewApi';
...
export function HomePage({ onReviewReady }) {
  ...
  const submit = async (event) => {
    ...
    try { onReviewReady(await submitGuaranteeForReview({ bgFile, crlFile })); }
